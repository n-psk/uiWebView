...
// function reduce() {
//     addValue -= 1
//     document.getElementById('numberValue').value = addValue
//     controlValue.valueNumber = addValue
//     console.log(controlValue);
//     document.getElementById('numberProduct').innerText = controlValue.valueNumber + " " + controlValue.textProduct
...
//     controlValue.valueNumber = addValue
//     console.log(controlValue.valueNumber + " " + controlValue.textProduct);
